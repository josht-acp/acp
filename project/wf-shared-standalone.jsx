...
const HeroAsym = () => (
  <section className="wf-hero-asym" style={{position:'relative'}}>
    <div className="wf-hero-asym-grid">
      ...
      <div>
        <div className="wf-hero-asym-image" style={{backgroundImage:`url(${window.__resources && window.__resources.everestPeak ? window.__resources.everestPeak : 'assets/everest-peak-clean.png'})`, backgroundColor:'#06080F', backgroundSize:'contain', backgroundRepeat:'no-repeat', backgroundPosition:'center bottom', filter:'saturate(0.85) brightness(0.95)', border:'none'}}/>
